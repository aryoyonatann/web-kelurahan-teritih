...
.aktivitas-tbl td { padding:11px 16px; border-bottom:1px solid var(--border); color:var(--slate); vertical-align:middle; }
...
.month-empty { padding:48px 20px; text-align:center; color:var(--muted); font-size:13px; }
...
<div class="page-wrapper">
    ...
    <div class="dash-hero mb-4">
        ...
        <div class="dash-hero-date" id="btn-open-month-modal" style="position:relative;z-index:1"
             title="Klik untuk lihat data permohonan per bulan">
            ...
            <div class="dash-card">
                <div class="dash-card-header">
                    <div class="dash-card-title">
                        ...
                        <span id="dash-notif-count"
                              style="font-size:11px;font-weight:600;background:#eff6ff;color:#1c64f2;border-radius:20px;padding:2px 8px;display:none"></span>
                    </div>
                </div>
                            ...
                            <tr>
                                <td>
                                    <div class="user-cell">
                                        ...
                                        <div class="user-nm">{{ $namaPemohon }}</div>
                                    </div>
                                </td>
                                <td>
                                    <span class="user-nik">{{ $p->nik_pemohon ?? $p->user->nik ?? '-' }}</span>
                                </td>
                                ...
                                <td>
                                    <a href="{{ route('permohonan.show', $p->id_permohonan) }}"
                                       class="action-icon-btn edit" title="Lihat detail">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                </td>
                            </tr>
    ...
    <div class="month-modal">
        <div class="month-modal-header">
            <div class="month-modal-title">
                <i class="bi bi-calendar3"></i> Data Permohonan per Bulan
            </div>
