...
@push('styles')<style>
    ...
    .btn-simpan { display: inline-flex; align-items: center; gap: 6px; padding: 9px 22px; border-radius: 9px; border: none; background: #1c64f2; font-size: 13px; font-weight: 700; color: white; cursor: pointer; transition: all .15s; }
    .btn-simpan:hover { background: #1a56db; transform: translateY(-1px); box-shadow: 0 4px 12px rgba(37,99,235,.3); }
