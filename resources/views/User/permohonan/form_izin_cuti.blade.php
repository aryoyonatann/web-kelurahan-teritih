...
<head>
    ...
    <title>Surat Keterangan Izin Cuti – Kelurahan Teritih</title>
...
<div class="form-page">
    ...
    <div class="form-hero">
        <div style="position:relative;z-index:1">
            <div class="form-hero-badge">
                <i class="bi bi-calendar-check-fill"></i> FORMULIR PERMOHONAN
            </div>
            <div class="form-hero-title">Surat Keterangan Izin Cuti</div>
    ...
    <form method="POST" action="{{ route('user.permohonan.store.surat', 'izin-cuti') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="card-section">
            <div class="card-section-head">
                ...
                <div class="card-section-title">Detail Izin Cuti</div>
            </div>
            <div class="card-section-body">
                <div class="row g-3">
                    <div class="col-md-6">
                        <label class="form-label-custom">Nama Perusahaan / Instansi <span class="req">*</span></label>
                        <input type="text" name="nama_perusahaan"
                            class="form-control @error('nama_perusahaan') is-invalid @enderror"
                            value="{{ old('nama_perusahaan') }}" placeholder="Nama tempat kerja" required>
                        @error('nama_perusahaan')<span class="invalid-feedback">{{ $message }}</span>@enderror
                    </div>
                    <div class="col-md-6">
                        <label class="form-label-custom">Lama Cuti (hari) <span class="req">*</span></label>
                        <input type="number" name="lama_cuti" class="form-control"
                            value="{{ old('lama_cuti') }}" placeholder="Jumlah hari" min="1" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label-custom">Tanggal Mulai Cuti <span class="req">*</span></label>
                        <input type="date" name="tanggal_mulai_cuti"
                            class="form-control @error('tanggal_mulai_cuti') is-invalid @enderror"
                            value="{{ old('tanggal_mulai_cuti') }}" required>
                        @error('tanggal_mulai_cuti')<span class="invalid-feedback">{{ $message }}</span>@enderror
                    </div>
                    <div class="col-md-6">
                        <label class="form-label-custom">Tanggal Selesai Cuti <span class="req">*</span></label>
                        <input type="date" name="tanggal_selesai_cuti"
                            class="form-control @error('tanggal_selesai_cuti') is-invalid @enderror"
                            value="{{ old('tanggal_selesai_cuti') }}" required>
                        @error('tanggal_selesai_cuti')<span class="invalid-feedback">{{ $message }}</span>@enderror
                    </div>
                    <div class="col-12">
                        <label class="form-label-custom">Keperluan / Alasan Cuti <span class="req">*</span></label>
                        <input type="text" name="keperluan"
                            class="form-control @error('keperluan') is-invalid @enderror"
                            value="{{ old('keperluan') }}" placeholder="Contoh: Resepsi pernikahan anak, Khitanan anak, dll." required>
