...
<head>
    ...
    <title>Surat Keterangan Tidak Mampu (SKTM) – Kelurahan Teritih</title>
...
<div class="form-page">
    ...
    <div class="form-hero">
        <div style="position:relative;z-index:1">
            <div class="form-hero-badge">
                <i class="bi bi-currency-dollar"></i> FORMULIR PERMOHONAN
            </div>
            <div class="form-hero-title">Surat Keterangan Tidak Mampu (SKTM)</div>
    ...
    <form method="POST" action="{{ route('user.permohonan.store.surat', 'sktm') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="card-section">
            <div class="card-section-head">
                ...
                <div class="card-section-title">Keperluan Surat</div>
            </div>
            <div class="card-section-body">
                <div class="row g-3">
                    <div class="col-12">
                        <label class="form-label-custom">Tujuan / Keperluan SKTM <span class="req">*</span></label>
                        <select name="keperluan_sktm" class="form-select @error('keperluan_sktm') is-invalid @enderror" required>
                            <option value="">Pilih tujuan...</option>
                            <option value="Berobat/Rawat di Rumah Sakit" {{ old('keperluan_sktm')=='Berobat/Rawat di Rumah Sakit'?'selected':'' }}>Berobat / Rawat di Rumah Sakit</option>
                            <option value="Pengajuan Beasiswa" {{ old('keperluan_sktm')=='Pengajuan Beasiswa'?'selected':'' }}>Pengajuan Beasiswa</option>
                            <option value="Persyaratan Sekolah" {{ old('keperluan_sktm')=='Persyaratan Sekolah'?'selected':'' }}>Persyaratan Sekolah</option>
                            <option value="Pengajuan Bantuan Sosial" {{ old('keperluan_sktm')=='Pengajuan Bantuan Sosial'?'selected':'' }}>Pengajuan Bantuan Sosial (Bansos)</option>
                            <option value="Keperluan Lainnya" {{ old('keperluan_sktm')=='Keperluan Lainnya'?'selected':'' }}>Keperluan Lainnya</option>
                        </select>
                        @error('keperluan_sktm')<span class="invalid-feedback">{{ $message }}</span>@enderror
                    </div>
                    <div class="col-12">
                        <label class="form-label-custom">Keterangan Tambahan (Opsional)</label>
                        <textarea name="keterangan_tambahan" class="form-control" rows="2"
                            placeholder="Contoh: untuk berobat di RSUD Kota Serang...">{{ old('keterangan_tambahan') }}</textarea>
                    </div>
                </div>
            </div>
        </div>
