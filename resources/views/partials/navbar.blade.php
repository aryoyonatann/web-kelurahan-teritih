...
<nav class="main-nav">
    ...
    <ul class="nav-links">
        ...
        <li><a href="{{ route('berita') }}"    class="{{ request()->routeIs('berita', 'berita.detail') ? 'active' : '' }}">Berita & Pengumuman</a></li>
    </ul>
...
<div class="mobile-drawer" id="mobileDrawer">
    ...
    @else
        <div class="drawer-user-section">
            <div class="drawer-avatar">
                <i class="bi bi-person" style="font-size:22px; color:white;"></i>
            </div>
            <div>
                <div class="drawer-user-name">Selamat Datang</div>
                <div class="drawer-user-role">Silakan login untuk melanjutkan</div>
            </div>
        </div>
    @endauth
    ...
    <div class="drawer-nav-links">
        ...
        <a href="{{ route('berita') }}"    class="drawer-nav-link {{ request()->routeIs('berita', 'berita.detail') ? 'active' : '' }}"><i class="bi bi-newspaper"></i> Berita & Pengumuman</a>
        ...
        @else
            ...
            <div class="drawer-guest-section">
                <a href="{{ route('login') }}" class="drawer-btn-masyarakat">
                    <i class="bi bi-box-arrow-in-right"></i> Login Masyarakat
                </a>
            </div>
        @endauth
...
(function() {
    ...
    if (lo) lo.addEventListener('click', function(e) { if (e.target === this) hideLogoutConfirm(); });
